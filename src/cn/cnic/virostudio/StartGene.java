...
//		con.close();
		ClassPathXmlApplicationContext con2 = new ClassPathXmlApplicationContext(
				new String[] { "gene-job-three.xml"});
		Step step3 = con2.getBean("step", Step.class);
		loginfo.info("gene数据总条数是： "+step3.doStep(0));
		con2.close();
	}
}
